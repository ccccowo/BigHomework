...
import { getAllTestAPI } from '../../api/test';
...
// 单卷分析柱状图y轴数值
const data3 = ref([5, 20, 36, 10, 10, 20])
...
<template>
  <div>
    <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
        ...
        <!-- <div class="top">
          <el-form>
            <el-form-item label="名称:">
              <el-input size="large" placeholder="请输入名称"></el-input>
            </el-form-item>
            <el-form-item>
        ...
        <ul class="bottom">
          <li v-for="one in oneList">
            <a href="javascript:;" @click="onLookFenxi(one)">
              ...
              <div class="content">
                {{ one.examName }}
                <el-button @click="onLookFenxi(one)" class="start" type="primary" plain>查看单卷分析</el-button>
              </div>
            </a>
          </li>
        </ul>
      ...
      <!-- <el-tab-pane label="个人分析" name="three">
        <div class="top">
          <el-form>
            <el-form-item label="班级">
              <el-select size="large" v-model="value" placeholder="请选择班级">
                <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="学号:">
              <el-input size="large" placeholder="请输入学号"></el-input>
            </el-form-item>
            <el-form-item label="姓名:">
              <el-input size="large" placeholder="请输入姓名"></el-input>
            </el-form-item>
            <el-form-item>
              <el-button size="large" type="primary">
                搜索
