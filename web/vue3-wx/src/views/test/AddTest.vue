...
const onQuesSearch = async () => {
  console.log(quesSelectValue.value)
...
<template>
  <div class="contaniner">
    <el-tabs type="card" v-model="activeName" class="demo-tabs" @tab-click="handleClick">
      <el-tab-pane label="试题" name="first">
        <div class="top">
          <!-- <el-button @click="questypedialog = true" class="add" type="primary" size="large">添加题型</el-button> -->
          <el-form>
            ...
            <el-form-item>
              <el-button @click="onQuesSearch" size="large" type="primary">
                搜索
              </el-button>
            </el-form-item>
            <el-form-item>
        ...
        <ul class="bottom" v-if="quesList.length != 0">
          <el-scrollbar>
            <li @click="onClickQues(ques)" v-for="ques in quesList" :key="ques.quesId">
              <a href="javascript:;">
                <el-button color="DodgerBlue" plain type="success">{{ quesTypeList[ques.quesKindId - 1].quesKindName
                }}</el-button>
                <div class="content">
      ...
      <el-tab-pane label="试卷" name="second">
        <div class="top">
          ...
          <span>已选 3</span> -->
          <el-button @click="$router.push('/carve')" class="add" type="primary" size="large">添加试卷</el-button>
        </div>
          ...
          <li v-for="paper of paperList">
            <a href="javascript:;">
              ...
              <svg class="icon testIcon" aria-hidden="true">
                <use xlink:href="#icon-a-044_kaoshi"></use>
              </svg>
              <div class="content">
      ...
      <el-tab-pane label="考试" name="three">
        <div class="top">
          <!-- <el-checkbox v-model="checkAll" @change="handleCheckAllChange"></el-checkbox>
          <span>已选 3</span> -->
          <el-button @click="onAddTest" class="add" type="primary" size="large">添加考试</el-button>
        </div>
    ...
    <el-dialog class="questypedialog" v-model="questypedialog" width="400">
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button type="primary" @click="onQuesTypeComfirm">
            确定
          </el-button>
        </div>
      </template>
  ...
  <el-dialog v-model="testShowDialog" width="400">
    ...
    <template #footer>
      <span class="dialog-footer">
        <el-button @click="testShowDialog = false" type="primary">确认</el-button>
      </span>
    </template>
  </el-dialog>
</template>
