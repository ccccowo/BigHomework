...
const onUploadConfirm = async () => {
  ...
  console.log("开始请求接口批量切割答卷and获取准考证号")
...
const showImgList = ref([
  'http://8.137.85.0:8008/files/download/img903bae08-ea84-11ee-9d5a-00163e04f5e4.png',
  'http://8.137.85.0:8008/files/download/img9c566ebc-ea84-11ee-9d5a-00163e04f5e4.png'
])
const excel = ref('http://8.137.85.0:8008/files/download/imgaba8f682-ea84-11ee-9d5a-00163e04f5e4.xlsx')
</script>
<template>
  <div>
          ...
          <li v-for="aw in awList2" :key="aw.examId">
            <a href="javascript:;">
              ...
              <div class="content">
                ...
                <!-- <el-button @click="onFenpei(aw.examId)" class="start" type="primary" plain>分配阅卷任务</el-button> -->
              </div>
            </a>
          </li>
        </ul>
    ...
    <el-dialog v-model="uploadDialog">
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button @click="onUploadConfirm" type="primary">确认上传</el-button>
        </span>
      </template>
    </el-dialog>
  </div>
