...
<template>
    <div class="box">
        <div class="header">
            ...
            <div class="right">
                <el-button @click="onComfirmResult">提交阅卷结果</el-button>
            </div>
        </div>
        <div class="main">
            <!-- 学生名单渲染 -->
                        ...
                        <el-collapse-item v-for="(ques, QIndex) of quesList" :name="QIndex" :key="QIndex">
                            ...
                            <ul>
                                <li @click="onClickStu(ques, stu, QIndex, SIndex)" v-for="(stu, SIndex) of stuList"
                                    :key="stu.id">
                                    <a :class="{ active: activeIndex1 == QIndex && activeIndex2 == SIndex }" href="javascript:;"
                                        v-if="!isShowName">{{ stu.stuId }}</a>
                                    <a :class="{ active: activeIndex1 == QIndex && activeIndex2 == SIndex }" href="javascript:;"
                                        v-if="isShowName">{{ stu.stuName }}</a>
                                </li>
                            </ul>
                        </el-collapse-item>
                    </el-collapse>
                ...
                <div class="bottom">
                    <el-form>
                        <el-form-item>
                            ...
                            <el-button @click="getAIScore" class="wenti" type="success">获取AI打分</el-button>
                        </el-form-item>
                        <el-form-item>
                    ...
                    <el-tabs tab-position="left">
                        <el-tab-pane label="AI评价" v-for="comment of AIComment" :key="comment">
                            <el-input :value="comment" :autosize="{ minRows: 6, maxRows: 10 }" type="textarea" />
                            <el-button @click="getAIComment" type="success">获取AI评价</el-button>
                        </el-tab-pane>
                    </el-tabs>
                    <div class="comment">
                    ...
                    <div class="end">
                        ...
                        <el-button :disabled="quesIndex == quesList.length && sindex == stuList.length - 1" size="large" type="info"
                            @click="onNext">下一份</el-button>
